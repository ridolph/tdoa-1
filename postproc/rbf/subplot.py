...
pos1=np.loadtxt('plotRBF\\6resultRandom10-0.txt')
pos2=np.loadtxt('plotRBF\\6resultRandom20-5.txt')
pos3=np.loadtxt('plotRBF\\6resultSine10-0.txt')
pos4=np.loadtxt('plotRBF\\6resultSine20-5.txt')
pos5=np.loadtxt('plotRBF\\6resultHelix10-0.txt')
pos6=np.loadtxt('plotRBF\\6resultHelix20-5.txt')
...
ax1.scatter(pos1[:,1],pos1[:,2],pos1[:,3],
            s=40,marker='^',color='seagreen',label='RBF position',alpha=0.8)   
